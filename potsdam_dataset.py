...
class PotsdamDataset(Dataset):
    def __init__(self, data_root='../GeoSeg/data/po/test', mode='val', img_dir='images_1024', mask_dir='masks_1024',
    ...
    def __getitem__(self, index):
        ...
        #     canny, canny_2, canny_3 = canny_dec(mask.copy(), False)
        # else:
        canny, canny_2, canny_3, rg1, rg2, rg3 = canny_dec(mask.copy(), False)
        mask = torch.from_numpy(mask).long()
        rg1 = torch.from_numpy(rg1).long()
        rg2 = torch.from_numpy(rg2).long()
        rg3 = torch.from_numpy(rg3).long()
        img_id = self.img_ids[index]
        results = dict(img_id=img_id, img=img, gt_semantic_seg=mask, canny=canny, canny_2=canny_2, canny_3=canny_3, rgb_resize=rg1, rgb_resize_2 =rg2, rgb_resize_3=rg3)
